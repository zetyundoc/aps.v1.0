...
1. 在浏览器中输入 http://&lt;IP&gt;:28083，其中IP为dockerfly所在服务器的IP地址。
...
在浏览器中访问[http://&lt;IP&gt;:28083，其中IP为dockerfly所在服务器的IP地址。进入Dockerfly登录界面，通过用户名和密码登录。](http://<IP>:28083，其中IP为dockerfly所在服务器的IP地址。进入Dockerfly登录界面，通过用户名和密码登录。)
